...
namespace MiataProjectTracker.Migrations
{
    ...
    [Migration("20250219003936_changedatabasebackfromsubtasks")]
    partial class changedatabasebackfromsubtasks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiataProjectTracker.Models.BuildTasks", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("DependsOnTaskIds")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MiataProjectTracker.Models.SubTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("BuildTaskId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("MiataProjectTracker.Models.SubTask", b =>
                {
                    b.HasOne("MiataProjectTracker.Models.BuildTasks", "BuildTask")
                        .WithMany("Subtasks")
                        .HasForeignKey("BuildTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BuildTask");
                });
